...
file_handler = logging.FileHandler("iris_classifier_v2.log")
...
class IrisClassifier:
    def __init__(self):
        ...
        logger.info("Data Iris Classifier V2 loaded")
        self.clf = self.export_model()
        logger.info("Model Iris Classifier V2 exported and saved")
    ...
    def export_model(self):
        ...
        logger.info("Model Iris Classifier V2 trained")
        return 0
